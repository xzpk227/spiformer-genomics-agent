...
5. predict_splicing - Run splicing impact prediction for variants
6. run_enrichment_analysis - Run GO/KEGG pathway enrichment analysis
7. generate_report - Generate a structured HTML/PDF report with plots
